...
public class Exo2 {
	...
	class Fille extends Meret {
		...
		String g() {System.out.println("Fille-g"); return "C";} 
		char h() {System.out.println("Fille_h"); return 'c';} 
		int i() {System.out.println("Fille_1"); return 3; }
		
		void j() throws IOException {System.out.println("Fille-j"); } 
		void k() throws Exception {System.out.println("Fille_k"); } 
		void l() {System.out.println("Fille_1");} 
